...
const typed = new Typed("#prompts-sample", {
	strings: [
		"Check this product design for EU CE compliance gaps?",
		"Show me all aftermarket suppliers for the Bosch 0445010507 common rail fuel pump in the EU, and list their 2025 pricing trends compared to OEM rates?",
		"Generate an optimal design variant for a lightweight gear assembly?",
		"Predict when this CNC machine will need maintenance?",
		"Organize these CAD files by project, version, and owner?",
		"Highlight all potential QC failures from last month’s production run?",
	],
	typeSpeed: 80,
	smartBackspace: true,
	loop: true,
...
// Run once on page load (check saved theme/localStorage too if you want)
updateLogo();
updateCaseStudyLogo();
